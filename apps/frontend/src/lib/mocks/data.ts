...
export const INGESTION_PENDING: IngestionItem[] = [
  {
    ...
    uploadedByOid: AUTHOR_OIDS.andres,
    uploadedAt: "2026-05-18T09:30:00.000Z",
    blobPath: "ing-0001/Politica_Seguridad_QA_v3.docx",
    errorDetail: null,
  },
  {
    id: "ing-0002",
    filename: "Plantilla-Casos-Aceptacion.xlsx",
    sizeBytes: 655_360,
    paginas: 1,
    ...
    version: "",
    status: "en-revision",
    uploadedByOid: AUTHOR_OIDS.camila,
    uploadedAt: "2026-05-17T14:10:00.000Z",
    blobPath: "ing-0002/Plantilla-Casos-Aceptacion.xlsx",
    errorDetail: null,
  },
  {
    id: "ing-0003",
    filename: "Memoria-Tecnica-Migracion-PG.pdf",
    sizeBytes: 1_048_576,
    paginas: 8,
    carpetaSugerida: "TEC",
    tipoSugerido: "MTEC",
    aprobadorOid: AUTHOR_OIDS.andres,
    aprobadorName: "Andrés Altamiranda",
    fechaAprobacion: "2026-05-10",
    fuenteOriginal: "Drive/Arquitectura/",
    version: "2.0",
    status: "indexado",
    uploadedByOid: AUTHOR_OIDS.andres,
    uploadedAt: "2026-05-09T11:00:00.000Z",
    blobPath: "ing-0003/Memoria-Tecnica-Migracion-PG.pdf",
    errorDetail: null,
  },
  {
    id: "ing-0004",
    filename: "borrador-sin-estructura.pdf",
    sizeBytes: 204_800,
    paginas: 2,
    carpetaSugerida: null,
    tipoSugerido: null,
    ...
    status: "rechazado",
    uploadedByOid: AUTHOR_OIDS.camila,
    uploadedAt: "2026-05-16T08:00:00.000Z",
    blobPath: "ing-0004/borrador-sin-estructura.pdf",
    errorDetail: "No se pudo extraer texto del archivo.",
  },
];
